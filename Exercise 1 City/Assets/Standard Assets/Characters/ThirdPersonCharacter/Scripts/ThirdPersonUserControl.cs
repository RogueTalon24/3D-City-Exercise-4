...
namespace UnityStandardAssets.Characters.ThirdPerson
{
    ...
    public class ThirdPersonUserControl : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            //RaycastHit hit;
            //Vector3 fwd = m_Character.transform.TransformDirection(Vector3.forward);
            //if (Physics.Raycast(m_Character.transform.position, fwd, out hit)) 
            //{
                //aimLoc = Camera.main.WorldToScreenPoint(hit.point);
            //}
            aimLoc = mainCam.WorldToScreenPoint(Input.mousePosition);
